...
x8s4_uzDivniekiem <- data.frame()
x8s4_uzCetriniekiem <- data.frame()
x8s4_uzSesi <- data.frame()
x8s4_uzSeptini <- data.frame()

if (x8s4$PS_code[1] == '__________' && x8s4$NM_code[1] == '__________') {
  ...
  cS <- list(c(2, 4, 6, 8), c(1, 4, 6, 7), c(2, 3, 6, 8), c(2, 3, 5, 7), c(2, 3, 5, 8), c(1, 4, 5, 7), c(1, 3, 6, 8), c(1, 3, 5, 7), c(2, 3, 6, 7))
  found_match <- FALSE
