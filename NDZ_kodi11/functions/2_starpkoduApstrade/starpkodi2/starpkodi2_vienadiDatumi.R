...
if ((t$zinkod[1] == "11" && t$zinkod[2] %in% c("40", "50", "53")) ||
  ...
  yt <- y2[v:(v+1),] 
  yt <- yt[yt$zinkod == "53", ]
} else if (t$zinkod[1] == "25" && t$zinkod[2] == "91" && t$PS_code[1] == '________' && t$NM_code[1] == '___________') {
  yt <- y2[v:(v+1),] 
  yt <- yt[yt$zinkod == "11", ]
...
} else if (t$zinkod[1] == "50" && t$zinkod[2] == "53" && t$PS_code[1] == '__________' && t$NM_code[1] == '_____________') {
  yt <- y2[v:(v+1), ]
  yt <- yt[yt$zinkod == "50", ]
