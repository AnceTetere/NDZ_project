starpkodi4_11_50 <- function(y2, t, prev, v) {
  ...
  if (t$NDZ_sanemsanas_datums[1] == t$NDZ_sanemsanas_datums[2] && t$zinkod[3] == "51" && t$zinkod[4] == "21" && t$NDZ_sanemsanas_datums[3] != t$NDZ_sanemsanas_datums[4]) {
    yt <- y2[v, ]
  ...
  } else if (t$zinkod[3] == "51" && t$zinkod[4] == "50" && 
