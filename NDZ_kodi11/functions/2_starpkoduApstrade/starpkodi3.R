starpkodi3 <- function(y2, t, prev, v) {  
  ...
  #           t$PS_code[1] == '___________' && t$nmrkod[1] == '_________') {
  #  yt <- y2[v, ]
  #  yt$dienas <- as.numeric(difftime(t$beidz[3], prev, units = "days")) - 1
    ...
    #           t$NDZ_sanemsanas_datums[2] != t$NDZ_sanemsanas_datums[3] &&
    #           t$PS_code[1] == '___________' && t$nmrkod[2] == '___________') {
    #  yt <- y2[v:(v+1), ]
    #  yt <- yt[yt$zinkod == "81", ]
    ...
    #           all(t$PS_code == '____________') && all(t$nmrkod == '----------')) {
    #  yt <- y2[v, ]
    #  yt$dienas <- 1
    #} else if (t$zinkod[1] == "11" && t$zinkod[2] == "81" &&
    #           t$zinkod[3] == "82" && 
    ...
    #           t$NDZ_sanemsanas_datums[2] != t$NDZ_sanemsanas_datums[3] &&
    #           all(t$PS_code == '_____________') && all(t$nmrkod == '______')) {
    #  
    #  yt <- y2[v, ]
    ...
    #           t$zinkod[3] == "81" && 
    #           all(diff(t$NDZ_sanemsanas_datums) == 0) &&
    #           all(t$PS_code == '___________') && all(t$nmrkod == '__________')) {
    ...
    #          t$NDZ_sanemsanas_datums[1] != t$NDZ_sanemsanas_datums[2] && 
    #          all(t$PS_code == '_________') && all(t$nmrkod == '__________')) {
    ...
    #           all(diff(t$NDZ_sanemsanas_datums[1:2]) == 0) &&
    #           t$NDZ_sanemsanas_datums[2] != t$NDZ_sanemsanas_datums[3] &&
    #           all(t$PS_code == 'PKFEFFF8D12') && all(t$nmrkod == '90000024455')) {
    ...
    #  yt$dienas <- as.numeric(difftime(t$beidz[3], t$sak[1], units = "days")) + 1 
      ...
      rm(days1, days2)
    } else if (t$zinkod[1] == "51" && t$zinkod[2] == "21" && t$zinkod[3] == "11" && 
              all(!diff(t$NDZ_sanemsanas_datums) == 0)) {
      ...
      yt$dienas <- sum(days1, days2)
      rm(days1, days2)
    } else if (t$zinkod[1] == "51" && t$zinkod[2] == "25" && t$zinkod[3] == "50" && 
