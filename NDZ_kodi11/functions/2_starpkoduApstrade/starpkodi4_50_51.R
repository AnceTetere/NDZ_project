starpkodi4_50_51 <- function(y2, t, prev, v) {
  if (t$zinkod[3] == "25" && t$zinkod[4] == "51" && 
      t$NDZ_sanemsanas_datums[1] == t$NDZ_sanemsanas_datums[2] &&
      t$NDZ_sanemsanas_datums[3] == t$NDZ_sanemsanas_datums[4]) {
     yt <- y2[v, ]
    yt$dienas <- 0
  } else if (t$zinkod[3] == "25" && t$zinkod[4] == "50" && 
    ...
    yt <- y2[v, ]
    yt$dienas <- days
  } else if (t$zinkod[3] == "21" && t$zinkod[4] == "51" && 
             t$NDZ_sanemsanas_datums[1] == t$NDZ_sanemsanas_datums[2] &&
             t$NDZ_sanemsanas_datums[2] != t$NDZ_sanemsanas_datums[3] &&
             t$NDZ_sanemsanas_datums[3] == t$NDZ_sanemsanas_datums[4]) {
    yt <- y2[v, ]
    yt$dienas <- 0
  } else if (t$zinkod[3] == "25" && t$zinkod[4] == "11" && 
    ...
    yt$dienas <- sum(days1, days2, days3)
    rm(days1, days2, days3)
  } else if (t$zinkod[3] == "50" && t$zinkod[4] == "25" && all(diff(t$NDZ_sanemsanas_datums) != 0)) {
    days1 <- as.numeric(difftime(t$beidz[1], prev, units = "days")) - 1 
    days2 <- as.numeric(difftime(t$beidz[3], t$sak[2], units = "days"))
    ...
    yt$dienas <- sum(days1, days2, days3)
    rm(days1, days2, days3)
  } else if (t$zinkod[3] == "50" && t$zinkod[4] == "21" && 
    ...
    stop("starpkodi4_50_51: Trūkst izstrādes koda.")
  }
