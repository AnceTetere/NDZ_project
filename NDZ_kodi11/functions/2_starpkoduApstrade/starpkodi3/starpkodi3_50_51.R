  ...
  yt <- y[v, ]
    ...
    if (t$zinkod[3] %in% c("21", "22", "23", "24", "25", "29")) {
               if (all(diff(t$NDZ_sanemsanas_datums) != 0)) {
                ...
                if (t$period[1] == '______' && t$PS_code[1] %in% c('_____________', 
                                                                      '_____________', 
                                                                      '_____________',
                                                                      '_____________',
                                                                      '_____________',
                                                                      '_____________') && 
                    t$NM_code[1] %in% c('_____________', 
                                       '_____________', 
                                       '_____________',
                                       '_____________',
                                       '_____________',
                                       '_____________')) {
                   yt$dd <- 0
                } else if (t$PS_code[1] %in% c('_____________', '_____________', '_____________', '_____________') && t$NM_code[1] == '_____________') {
                  yt$dd <- 0
                } else if (t$period[1] == '______' && t$PS_code[1] %in% c('_____________', '_____________') && t$NM_code[1] %in% c('_____________', '_____________')) {
                  yt$dd <- as.numeric(diff(t$NDZ_sanemsanas_datums[1:2]))
                } else if (t$period[1] == '______' && t$PS_code[1] == '_____________' && t$NM_code[1] == '_____________') {
             ...
             if (all(diff(t$NDZ_sanemsanas_datums) != 0)) {
               ...
               if(t$period[1] == "______" && t$PS_code[1] == '_____________' && t$NM_code[1] == '_____________') {
             ...
             if (diff(t$NDZ_sanemsanas_datums[2:3]) != 0 && diff(t$NDZ_sanemsanas_datums[1:2]) == 0) {
               if ((t$period[1] == "______" && t$PS_code[1] == '_____________' && t$NM_code[1] == '_____________') ||
                   (t$period[1] == "______" && t$PS_code[1] == '_____________' && t$NM_code[1] == '_____________')) {
                 yt$dd <- as.numeric(sum(difftime(t$NDZ_sanemsanas_datums[1], prev, units = "days") - 1,
