adj50 <- function(NDZ) {
 ...
 NDZ <- NDZ %>% 
    ...
    NDZ <- NDZ %>% 
      dplyr::filter(!(PS_code %in% c"___________", "___________" & NM_code == c"___________", "___________" & zinkod == '41'))
    NDZ <- NDZ %>% 
   ...
   NDZ <- NDZ %>% 
     dplyr::filter(!(PS_code ==  '______________' & NM_code ==  '______________' & NDZ_sanemsanas_datums == '___________'))
...
#SEKOJOŠĀS RINDAS IZŅĒMU
#  } else if (isTRUE(NDZ$period[1] == '______' & NDZ$zinkod[1] == "40")) {
    
   
    #NDZ <- NDZ %>% 
     # dplyr::filter(!(PS_code ==  '______________' & NM_code ==  '______________')) ]
        ...
        mutate(
          NDZ_sanemsanas_datums = if_else(
            PS_code ==  '______________' &
              ...
              zinkod == '50' &
              NDZ_sanemsanas_datums == as.Date'___________',
            as.Date'___________',
      ...
      NDZ <- NDZ %>% 
        dplyr::filter(!(PS_code == "___________" & NM_code ==  '______________' & zinkod == "25" & NDZ_sanemsanas_datums == "______________"))
        ...
        mutate(
          zinkod = ifelse(
            PS_code ==  '______________' &
              NM_code ==  '______________' &
              zinkod == '50' &
              NDZ_sanemsanas_datums == '___________',
            '51',
            zinkod
          ),
          sak_beidz = ifelse(
