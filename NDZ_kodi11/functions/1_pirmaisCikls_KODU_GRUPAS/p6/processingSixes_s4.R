processingSixes_s4 <- function(x6s4, o, kods) {
  ...
  if (all(x6s4$sak_beidz[c(1,2,4,6)] == "1")) { 
        if (all(diff(x6s4$NDZ_sanemsanas_datums) != 0)) {
          #JO PIRMOREIZ
            if (x6s4$period[1] == '202202' && x6s4$PS_code[1] == '______________' && x6s4$NM_code[1] == '______________') {
                x6s4_uzCetri <- x6s4[2:5, ]
                x6s4_uzVieniniekiem <- x6s4[6, ]
                if (kods %in% c("40", "50", "53") && o == "6") {ZERO_minus(x6s4 %>% slice(2))}
                 ...
                 #JO PIRMOREIZ
                 if (kods == "40") {
                   if (x6s4$period[1] == '202208' && x6s4$PS_code[1] == '______________' && x6s4$NM_code[1] == '______________') {
                        x6s4_uzCetri <- x6s4[2:5, ]; x6s4_uzVieniniekiem <- x6s4[6, ]
                     if (kods %in% c("40", "50", "53") && o == "6") {ZERO_minus(x6s4 %>% slice(1))}
                   } else {stop("processingSixes_s4 trūkst apstrādes koda. \n")}
                 } else {stop("processingSixes_s4 trūkst apstrādes koda. \n")}
             } else if (all(sapply(c(2,4), function(i) diff(x6s4$NDZ_sanemsanas_datums[i:(i+1)]) == 0)) && 
                        all(sapply(c(1,3,5), function(i) diff(x6s4$NDZ_sanemsanas_datums[i:(i+1)]) != 0))) {
                        #JO PIRMOREIZ
                        if (with(x6s4, period[1] == '202201' && PS_code[1] == '______________' && NM_code[1] == '______________')) {
                              x6s4_uzCetri <- x6s4[2:5, ]; x6s4_uzVieniniekiem <- x6s4[6, ]
                              if (kods %in% c("40", "50", "53") && o == "6") {ZERO_minus(x6s4 %>% slice(2))}
                        } else {stop("processingSixes_s4 trūkst apstrādes koda. \n")}
          } else {stop("processingSixes_s4 trūkst apstrādes koda. \n")}
            ...
            if (all(sapply(c(2,5), function(i) diff(x6s4$NDZ_sanemsanas_datums[i:(i+1)]) == 0)) &&
              ...
              if (all(sapply(c(1,2,4,5), function(i) diff(x6s4$NDZ_sanemsanas_datums[i:(i+1)]) != 0)) &&
                ...
                #JO PIRMOREIZ
                if (x6s4$period[1] == "202203" && x6s4$PS_code[1] == '______________' && x6s4$NM_code[1] == '______________') {
                       x6s4_uzCetri <- x6s4[1:4, ]; x6s4_uzVieniniekiem <- x6s4[6, ]
                       if (kods %in% c("40", "50", "53") && o == "6") {ZERO_minus(x6s4 %>% slice(1))}
                } else {stop("processingSixes_s4 trūkst apstrādes koda. \n")}
              } else if (diff(x6s4$NDZ_sanemsanas_datums[1:2]) == 0 && all(diff(x6s4$NDZ_sanemsanas_datums[2:6]) != 0)) {
                #JO PIRMO REIZ
                if (x6s4$period[1] == "202204" && x6s4$PS_code[1] == '______________' && x6s4$NM_code[1] == '______________') {
                  x6s4_uzCetri <- x6s4[1:4, ]; x6s4_uzVieniniekiem <- x6s4[6, ]
                  if (kods %in% c("40", "50", "53") && o == "6") {ZERO_minus(x6s4 %>% slice(1))}
                } else {stop("processingSixes_s4 trūkst apstrādes koda. \n")}
              } else {stop("processingSixes_s4 trūkst apstrādes koda. \n")}
           ...
           if (all(sapply(c(1,4), function(i) diff(x6s4$NDZ_sanemsanas_datums[i:(i+1)]) == 0)) &&
              ...
              if (x6s4$period[1] == '202201' && x6s4$PS_code[1] == '______________' && x6s4$NM_code[1] == '______________') {
                   x6s4 <- x6s4[c(2,4,5,6),]
                   x6s4_uzVieniniekiem <- x6s4[c(1,4),]; x6s4_uzDivniekiem <- x6s4[2:3,]
                
            } else if ((x6s4$period[1] == '202203' && x6s4$PS_code[1] == '______________' && x6s4$NM_code[1] == '______________') ||
                       (x6s4$period[1] == '202208' && x6s4$PS_code[1] == '______________' && x6s4$NM_code[1] == '______________')) {
                       #JO PIRMOREIZ
                       x6s4_uzVieniniekiem <- x6s4[6,]; x6s4_uzCetri <- x6s4[c(1,2,4,5), ]
                       if (kods %in% c("40", "50", "53") && o == "6") {ZERO_minus(x6s4 %>% slice(1))}
                       } else {stop("processingSixes_s4: trūkst apstrādes koda. \n")}
          } else if (all(diff(x6s4$NDZ_sanemsanas_datums) != 0)) {
                     #JA VISS KĀRTĪBĀ, ATBRĪVO
                     if ((x6s4$PS_code[1] == '______________' && x6s4$NM_code[1] == '______________') ||
                         (x6s4$period[1] == '202202' && x6s4$PS_code[1] == '______________' && x6s4$NM_code[1] == '______________') ||
                         (x6s4$period[1] == '202203' && x6s4$PS_code[1] == '______________' && x6s4$NM_code[1] == '______________') ||
                         (x6s4$period[1] == '202203' && x6s4$PS_code[1] == '______________' && x6s4$NM_code[1] == '______________') ||
                         (x6s4$period[1] == '202202' && x6s4$PS_code[1] == '______________' && x6s4$NM_code[1] == '______________') ||
                         (x6s4$period[1] == '202204' && x6s4$PS_code[1] == '______________' && x6s4$NM_code[1] == '______________')) {
             ...
             if (kods == "40") {
               if (all(sapply(c(3,5), function(i) diff(x6s4$NDZ_sanemsanas_datums[i:(i+1)]) == 0)) &&
                   all(sapply(c(1,2,4), function(i) diff(x6s4$NDZ_sanemsanas_datums[i:(i+1)]) != 0))) {
                         #JO PIRMOREIZ
                         if (x6s4$period[1] == '202205' && x6s4$PS_code[1] == '______________' && x6s4$NM_code[1] == '______________') {
                          ...
                          #JO PIRMOREIZ
                          if (x6s4$period[1] == '202209' && x6s4$PS_code[1] == '______________' && x6s4$NM_code[1] == '______________') {
                              x6s4_uzVieniniekiem <- x6s4[6,]; x6s4_uzDivniekiem <- x6s4[c(2,4), ]
                              if (kods %in% c("40", "50", "53") && o == "6") {ZERO_minus(x6s4 %>% slice(1))}
                         } else {stop("processingSixes_s4 trūkst apstrādes koda. \n")}
