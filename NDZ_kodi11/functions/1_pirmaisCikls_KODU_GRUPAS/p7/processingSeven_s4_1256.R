processingSeven_s4_1256 <- function(a, o, kods) {
  ...
  if (all(sapply(c(1,3,5), function(i) diff(a$NDZ_sanemsanas_datums[i:(i+1)]) != 0)) &&
    ...
    if ((a$period[1] == "__________" && a$PS_code[1] == "__________" && a$NM_code[1] == "__________") ||
        (a$period[1] == "__________" && a$PS_code[1] == "__________" && a$NM_code[1] == "__________") ||
        (a$period[1] == "__________" && a$PS_code[1] == "__________" && a$NM_code[1] == "__________") ||
        (a$period[1] == "__________" && a$PS_code[1] == "__________" && a$NM_code[1] == "__________") ||
        (a$period[1] == "__________" && a$PS_code[1] == "__________" && a$NM_code[1] == "__________") ||
        (a$period[1] == "__________" && a$PS_code[1] == "__________" && a$NM_code[1] == "__________") ||
