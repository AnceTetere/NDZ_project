processingSeven_b4 <- function(x7b4, o, kods) {
...
x7b4 <- x7b4 %>% arrange(NDZ_sanemsanas_datums)
  ...
  if ((all(x7b4$sak_beidz[1:2] == c("2", "1")) && diff(x7b4$NDZ_sanemsanas_datums[1:2]) != 0) || 
      (x7b4$sak_beidz[1] == x7b4$sak_beidz[2] && diff(x7b4$NDZ_sanemsanas_datums[2:3]) == 0)) {
              ...
              if (kods %in% c("40", "50", "53") && o == "7") {ZERO_plus(x7b4 %>% slice(7))}
  } else if (all(x7b4$sak_beidz == c("2","1","2","1","2","2","1")) && 
             diff(x7b4$NDZ_sanemsanas_datums[1:2]) == 0 && 
             x7b4$PS_code[1] ==  '______________'&& x7b4$NM_code[1] ==  '______________') {
            ...
            if (all(diff(x7b4$NDZ_sanemsanas_datums) != 0)) {
              if (
                  (x7b4$period[1] == '______' && x7b4$PS_code[1] ==  '______________' && x7b4$NM_code[1] ==  '______________') ||
                  (x7b4$period[1] == '______' && x7b4$PS_code[1] ==  '______________' && x7b4$NM_code[1] ==  '______________') ||
                  (x7b4$period[1] == '______' && x7b4$PS_code[1] ==  '______________' && x7b4$NM_code[1] ==  '______________')) {
    ...
    if (all(diff(x7b4$NDZ_sanemsanas_datums[1:4]) != 0)) {
      if ((x7b4$period[1] == '______' && x7b4$PS_code[1] ==  '______________' && x7b4$NM_code[1] ==  '______________') ||
          (x7b4$period[1] == '______' && x7b4$PS_code[1] ==  '______________' && x7b4$NM_code[1] ==  '______________')) {
