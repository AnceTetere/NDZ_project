...
x7b4 <- x7b4 %>% arrange(NDZ_sanemsanas_datums)
  ...
  if ((all(x7b4$sak_beidz[1:2] == c("2", "1")) && diff(x7b4$NDZ_sanemsanas_datums[1:2]) != 0) || 
      (x7b4$sak_beidz[1] == x7b4$sak_beidz[2] && diff(x7b4$NDZ_sanemsanas_datums[2:3]) == 0)) {
            if ((x7b4$period[1] ==  '______' && x7b4$PS_code[1] ==  '___________' && x7b4$NM_code[1] ==  '___________') ||
                (x7b4$period[1] ==  '______' && x7b4$PS_code[1] ==  '___________' && x7b4$NM_code[1] ==  '___________') ||
                (x7b4$period[1] ==  '______' && x7b4$PS_code[1] ==  '___________' && x7b4$NM_code[1] ==  '___________')) {
