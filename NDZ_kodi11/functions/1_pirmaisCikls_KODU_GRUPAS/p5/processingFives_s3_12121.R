...
if (diff(x5s3s$NDZ_sanemsanas_datums[3:4]) == 0 &&
    ...
    if((x5s3s$PS_code[1] %in% c('_____', 
                                   '_____', 
                                   '_____', 
                                   '_____', 
                                   '_____') && x5s3s$NM_code[1] %in% c('_____')) ||
       (x5s3s$PS_code[1] == '_____' && x5s3s$NM_code[1] == '_____') ||
       (x5s3s$PS_code[1] == '_____' && x5s3s$NM_code[1] == '_____')) {
      ...
      if((x5s3s$PS_code[1] == '_____' && x5s3s$NM_code[1] == '_____') ||
          (x5s3s$PS_code[1] == '_____' && x5s3s$NM_code[1] == '_____') ||
          (x5s3s$PS_code[1] == '_____' && x5s3s$NM_code[1] == '_____') ||
          (x5s3s$PS_code[1] == '_____' && x5s3s$NM_code[1] == '_____')) {
        x5s3s_uzVieniniekiem <- rbind(x5s3s_uzVieniniekiem, x5s3s[5,])
