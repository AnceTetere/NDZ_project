processingFives_s3e12 <- function(a, o, kods) {
  ...
  if (all(a$sak_beidz[c(2,4,5)] == "1")) {
          if((a$PS_code == "___________" && a$NM_code == "___________") ||
             (a$PS_code == "___________" && a$NM_code == "___________") ||
             (a$PS_code == "___________" && a$NM_code == "___________") ||
             (a$period[1] == "______" && a$PS_code == "___________" && a$NM_code == "___________") ||
             (a$period[1] == "______" && a$PS_code == "___________" && a$NM_code == "___________")) {
                a1 <- a[5,]; a2 <- a[c(2,1,4,3),]
    } else if (a$PS_code == "___________" && a$NM_code == "___________") {
    ...
    if ((a$PS_code == "___________" && a$NM_code == "___________" && a$period[1] == "______") ||
        (a$PS_code[1] %in% c"___________", "___________"a$NM_code == "___________" && a$period[1] == "______")) {
