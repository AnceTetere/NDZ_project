processingFives_s2e6 <- function(a, o, kods) {  
  ...
  if (all(a$sak_beidz[3:4] == "1")) {
           ...
           if ((a$PS_code[1] == '_________' && a$NM_code[1] == '__________') ||
               (a$PS_code[1] == '__________' && a$NM_code[1] == '__________') ||
               (a$period[1] == '_____' && a$PS_code[1] == '__________' && a$NM_code[1] == '__________') ||
               (a$period[1] == '_____' && a$PS_code[1] == '_________' && a$NM_code[1] == '__________') ||
               (a$period[1] == '_____' && a$PS_code[1] == '_________' && a$NM_code[1] == '__________') ||
               (a$period[1] == '_____' && a$PS_code[1] == '_________' && a$NM_code[1] == '__________')) {
                  a1 <- a[1,]; a2 <- a[2:5,]
           ...
           if ((a$PS_code[1] == '_________' && a$NM_code[1] == '__________') ||
               (a$PS_code[1] == '_________' && a$NM_code[1] == '__________')) {
                   a1 <- rbind(a1, a[c(1,5),])
                   a2 <- rbind(a2, a[3:4,])
           } else {stop("processingFives_s2e6: Trūkst apstrādes koda.")}
