            ...
            if (x10s5$sak_beidz[3] != "2") {
              if (diff(x10s5$NDZ_sanemsanas_datums[1:2]) == 0 && diff(x10s5$NDZ_sanemsanas_datums[2:3]) != 0) {
                if (x10s5$NM_code[1] == "__________" ||
                    (x10s5$period[1] == "_____" && x10s5$PS_code[1] == "_____" && x10s5$NM_code[1] == "_____") ||
                    (x10s5$period[1] == "_____" && x10s5$PS_code[1] == "_____" && x10s5$NM_code[1] == "_____") ||
                    (x10s5$period[1] == "_____" && x10s5$PS_code[1] == "_____" && x10s5$NM_code[1] == "_____")) {
                ...
                if (x10s5$sak_beidz[4] == "2") {
                  if (x10s5$sak_beidz[5] == "2") {
                    if (x10s5$sak_beidz[6] == "1") {
                        if (x10s5$period[1] == "_____" && x10s5$PS_code[1] == "_____" && x10s5$NM_code[1] == "_____") {
                         ...
                         if (diff(x10s5$NDZ_sanemsanas_datums[1:2]) != 0) {
                           ...
                           if ((x10s5$period[1] == "_____" && x10s5$PS_code[1] == "_____" && x10s5$NM_code[1] == "__________") ||
                               (x10s5$period[1] == "_____" && x10s5$PS_code[1] == "_____" && x10s5$NM_code[1] == "__________") ||
                               (x10s5$period[1] == "_____" && x10s5$PS_code[1] == "_____" && x10s5$NM_code[1] == "__________") ||
                               (x10s5$period[1] == "_____" && x10s5$PS_code[1] == "_____" && x10s5$NM_code[1] == "__________") ||
                               (x10s5$period[1] == "_____" && x10s5$PS_code[1] == "_____" && x10s5$NM_code[1] == "__________") ||
                               (x10s5$period[1] == "_____" && x10s5$PS_code[1] == "_____" && x10s5$NM_code[1] == "__________") ||
