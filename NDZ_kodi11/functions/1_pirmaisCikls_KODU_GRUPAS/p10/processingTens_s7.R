processingTens_s7 <- function(x10s7, o, kods) {
  ...
  #x10s7 <- x10
  x10s7_uzVieniniekiem <- data.frame(); x10s7_uzDivniekiem <- data.frame(); x10s7_uzPieci <- data.frame(); x10s7_uzSesi <- data.frame(); 
  x10s7_uzSeptini <- data.frame(); x10s7_uzAstoniekiem <- data.frame()
  ...
  return(list(x10_uzVieniniekiem = x10s7_uzVieniniekiem,
              ...
              x10_uzPieci = x10s7_uzPieci,
              x10_uzSesi = x10s7_uzSesi,
