  ...
  if (diff(a$NDZ_sanemsanas_datums[1:2]) == 0 && all(diff(a$NDZ_sanemsanas_datums[2:5]) != 0)) {
              #JO PIRMOREIZ
               if ((a$period[1] == "202202" && a$PS_code[1] == '______________' && a$NM_code[1] == '______________') ||
                   ...
                   (a$period[1] == "202204" && a$NM_code[1] == '______________') ||
                   (a$period[1] == "202205" && a$NM_code[1] == '______________') ||
                   (a$period[1] == "202206" && a$NM_code[1] == '______________') ||
             ...
             if ((a$period[1] == "202201" && a$PS_code[1] == '______________' && a$NM_code[1] == '______________') ||
                 (a$period[1] == "202206" && a$PS_code[1] == '______________' && a$NM_code[1] == '______________') ||
             ...
             #JO PIRMOREIZ
             if ((a$period[1] == "202201" && a$PS_code[1] == '______________' && a$NM_code[1] == '______________') ||
                 (a$period[1] == "202202" && a$PS_code[1] == '______________' && a$NM_code[1] == '______________') ||
                 (a$period[1] == "202203" && a$PS_code[1] == '______________' && a$NM_code[1] == '______________') ||
                 (a$period[1] == "202207" && a$PS_code[1] == '______________' && a$NM_code[1] == '______________') ||
                 (a$period[1] == "202208" && a$PS_code[1] == '______________' && a$NM_code[1] == '______________')) {
                 a1 <- a[1, ]; a7 <- a[3:9, ]
