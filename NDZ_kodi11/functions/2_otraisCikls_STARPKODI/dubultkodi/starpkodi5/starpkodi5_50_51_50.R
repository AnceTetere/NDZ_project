starpkodi5_50_51_50 <- function(y, t, prev, v) {
  ...
  if (t$zinkod[4] %in% c("41", "51", "54", "92")) {
    if (t$zinkod[5] %in% c("21", "22", "23", "24", "25", "29")) {
      ...
      } else if (diff(t$NDZ_sanemsanas_datums[1:2]) == 0 && all(diff(t$NDZ_sanemsanas_datums[2:5]) != 0)) {
        if(t$period[1] == "_____________" && t$PS_code[1] == "_____________" && t$NM_code[1] == "_____________") {
