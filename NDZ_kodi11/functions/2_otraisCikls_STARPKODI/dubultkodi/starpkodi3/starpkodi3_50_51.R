  ...
  yt <- y[v, ]
    ...
    if (t$zinkod[3] %in% c("21", "22", "23", "24", "25", "29")) {
               if (all(diff(t$NDZ_sanemsanas_datums) != 0)) {
                ...
                if (t$period[1] == '_____' && t$PS_code[1] %in% c('_____', 
                                                                      '_____', 
                                                                      '_____',
                                                                      '_____',
                                                                      '_____',
                                                                      '_____') && 
                    t$NM_code[1] %in% c('_____', 
                                       '_____', 
                                       '_____',
                                       '_____',
                                       '_____',
                                       '_____')) {
                   yt$dienas <- 0
                } else if (t$PS_code[1] %in% c('_____', '_____', '_____', '_____') && t$NM_code[1] == '_____') {
                  yt$dienas <- 0
                } else if (t$period[1] == '_____' && t$PS_code[1] %in% c('_____', '_____') && t$NM_code[1] %in% c('_____', '_____')) {
             ...
             if (all(diff(t$NDZ_sanemsanas_datums) != 0)) {
               ...
               if(t$period[1] == "_____" && t$PS_code[1] == 'PS_code' && t$NM_code[1] == '_____') {
