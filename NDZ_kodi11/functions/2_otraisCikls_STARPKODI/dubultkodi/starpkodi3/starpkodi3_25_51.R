starpkodi3_25_51 <- function(y, t, prev, v) {
  ...
  if (t$zinkod[3] %in% c("40", "50", "53", "91")) {
            if (all(diff(t$NDZ_sanemsanas_datums) == 0)) {
              if(t$period[1] == "___________" && t$PS_code[1] == '___________' && t$NM_code[1] == '___________') {
           ...
           if (diff(t$NDZ_sanemsanas_datums[2:3]) != 0 && diff(t$NDZ_sanemsanas_datums[1:2]) == 0) {
             ...
             } else if ((t$period[1] == '___________' && t$PS_code[1] == '___________' && t$NM_code[1] == '___________') ||
                        (t$period[1] == '___________' && t$PS_code[1] == '___________' && t$NM_code[1] == '___________')) {
