starpkodi3_50_51 <- function(y, t, prev, v) {
    ...
    if (t$zk[3] %in% c("21", "22", "23", "24", "25", "29")) {
               if (all(diff(t$NDZ_sanemsanas_datums) != 0)) {
                ...
                if (t$period[1] == '202101' && t$PS_code[1] %in% c('__________', 
                                                                   '__________', 
                                                                   '__________',
                                                                   '__________',
                                                                   '__________',
                  ...
                  yt <- y[v, ]
                  yt$dd <- 0
                } else if (t$period[1] == '202201' && t$PS_code[1] %in% c('__________') && t$NM_code[1] == '__________') {
                  yt <- y[v, ]
                  yt$dd <- as.numeric(diff(t$NDZ_sanemsanas_datums[c(2,1)]))
             ...
             if (all(diff(t$NDZ_sanemsanas_datums) != 0)) {
               ...
               if(t$period[1] == "202201" && t$PS_code[1] == '__________' && t$NM_code[1] == '__________') {
                 yt <- y[v, ]
...
#} else 
#} else if (t$zk[3] == "53" && all(diff(t$NDZ_sanemsanas_datums) != 0)) {
...
# rm(days1, days2)
#} else if (t$zk[3] == "25" && all(diff(t$NDZ_sanemsanas_datums) != 0)) {
